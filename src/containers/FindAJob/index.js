...
import { getJobs, addFavouriteJob, removeFavouriteJob, applyJob, applyJobsFlask } from "../../services/Jobs"
...
const FindAJob = () => {
 ...
 if(data?.Score <= 50)
        {
            enqueueSnackbar(`Dear Candiditate your score is ${data?.Score}, therefore,  You are not eligible  for this job`, {
                variant: "error",
                anchorOrigin: {
                    vertical: 'bottom',
                    horizontal: 'right',
            ...
            enqueueSnackbar(`Congratulation your score is ${data?.Score}, therefore, you have successfully applied to this job`, {
                variant: "success",
                anchorOrigin: {
                    vertical: 'bottom',
                    horizontal: 'right',
